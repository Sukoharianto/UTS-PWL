        ...
        <div class="panel-body">
          <form role="form">
              <div class="form-group">
                <label for="exampleInputPassword1">Tgl Agenda</label>
                <input type="text" name="Tgl_Agenda" id="Tgl_Agenda" class="form-control" value="<?php echo $val['Tgl_Agenda'];?>" placeholder="Masukkan Tgl Agenda">
                <input type="hidden" name="id" class="form-control" value="<?php echo $val['ID_FM'];?>">
              </div> 
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="Tgl_Surat" id="Tgl_Surat" class="form-control" value="<?php echo $val['Tgl_Surat'];?>"placeholder="Masukkan Tgl Surat">
              </div> 
              <div class="form-group">
                <label for="exampleInputPassword1">Asal Surat</label>
                <input type="text" name="Asal_Surat" class="form-control" value="<?php echo $val['Asal_Surat'];?>" id="exampleInputPassword1" placeholder="Masukkan Asal Surat">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="Tujuan" class="form-control" value="<?php echo $val['Tujuan'];?>" id="exampleInputPassword1" placeholder="Masukkan Tujuan">
              </div>
               <div class="form-group">
